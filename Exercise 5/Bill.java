...
interface BillGen            //interface to implement
{
  int calculate();
}

class Product implements BillGen  //class to implements
{
  String name;
...
Enter product 1 name:AMD ryzen
Enter product id:1001
Enter product quantity:2
Enter product unit price:3129
Enter product 2 name:INTEL ssd
...
-----------------------------------------------------------------------------
 1001            AMD ryzen                         2       3129        6258
 2255            INTEL ssd                         1        100        1100
-----------------------------------------------------------------------------
Net Amount:7358
-----------------------------------------------------------------------------
